                    ...
                    products.map((item, index) => {
                        ...
                        return (
                            <div onClick={() => handleProduct(item._id)} key={item._id} className="card m-3">
                                <div className='icon-container' onClick={(e) => handleLike(item._id, e)} >
                                    {
                                        likedproducts.find((likedItem) => likedItem._id === item._id) ? <FaHeart className='red-icons' /> : <FaHeart className='icons' />
